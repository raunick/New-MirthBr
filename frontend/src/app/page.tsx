...
import TestDrawer from "@/components/tools/TestDrawer";
    ...
    <ReactFlowProvider>
      <div className="h-screen w-screen flex flex-col overflow-hidden">
        <Header
          ...
          onTestChannel={() => setIsTestDrawerOpen(true)}
        />
        ...
        <div className="flex-1 flex overflow-hidden relative">
          ...
          <main className="flex-1 relative">
            ...
            <TestDrawer isOpen={isTestDrawerOpen} onClose={() => setIsTestDrawerOpen(false)} />
