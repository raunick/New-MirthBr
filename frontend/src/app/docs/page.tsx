                    ...
                    <section id="deduplication" className="mb-16">
                        ...
                        <InfoBox type="info" title="Comportamento dos Logs">
                            <ul className="list-disc list-inside space-y-1">
                                <li><code className="text-xs bg-[var(--background)] px-1 rounded">Message is duplicate, skipping</code> = Mensagem duplicada ignorada</li>
                                <li><code className="text-xs bg-[var(--background)] px-1 rounded">HTTP Message persisted to disk</code> = Nova mensagem salva</li>
                                <li><code className="text-xs bg-[var(--background)] px-1 rounded">Retrying message...</code> = RetryWorker tentando reprocessar</li>
                            </ul>
                        </InfoBox>
                    </section>
...
Authorization: Bearer your-api-key`}
                    ...
                    <section id="message-flow" className="mb-16">
                        ...
                        <div className="glass p-6 rounded-xl border border-[var(--glass-border)] space-y-4">
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-white font-bold shrink-0">1</div>
                                <div>
                                    <h4 className="font-semibold">Recebimento (Source)</h4>
                                    <p className="text-sm text-[var(--foreground-muted)]">HTTP Listener, TCP Listener, File Reader ou Database Poller recebem a mensagem.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold shrink-0">2</div>
                                <div>
                                    <h4 className="font-semibold">Persistência</h4>
                                    <p className="text-sm text-[var(--foreground-muted)]">A mensagem é salva no banco com status PENDING antes de qualquer processamento.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-full bg-purple-500 flex items-center justify-center text-white font-bold shrink-0">3</div>
                                <div>
                                    <h4 className="font-semibold">Deduplicação</h4>
                                    <p className="text-sm text-[var(--foreground-muted)]">Verifica se a mensagem já foi processada (hash check).</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center text-white font-bold shrink-0">4</div>
                                <div>
                                    <h4 className="font-semibold">Processamento (Processors)</h4>
                                    <p className="text-sm text-[var(--foreground-muted)]">Lua Scripts, HL7 Parser, Filters e Mappers transformam a mensagem.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-full bg-red-500 flex items-center justify-center text-white font-bold shrink-0">5</div>
                                <div>
                                    <h4 className="font-semibold">Saída (Destinations)</h4>
                                    <p className="text-sm text-[var(--foreground-muted)]">File Writer, HTTP Sender, Database Writer ou TCP Sender enviam a mensagem.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 rounded-full bg-green-600 flex items-center justify-center text-white font-bold shrink-0">6</div>
                                <div>
                                    <h4 className="font-semibold">Confirmação</h4>
                                    <p className="text-sm text-[var(--foreground-muted)]">Status atualizado para SENT. Em caso de erro, vai para ERROR com retry automático.</p>
                                </div>
                            </div>
                        </div>
                    </section>
